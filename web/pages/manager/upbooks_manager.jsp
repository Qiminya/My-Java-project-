    ...
    <script type="text/javascript">
        $(function (){
            ...
            $("#finddowns").click(function (){
                ...
                location.href="upServlet?action=pageAllUps&book_id="+book_id;
            });
            //给所有上架记录按钮添加点击事件
            $("#all").click(function (){
                location.href="upServlet?action=pageAllUps&book_id=";
            });
...
<div id="table">
    ...
    <table id="books_table" >
        <tr>
            <th class="liename" style="width: 180px;">上架图书</th>
            <th class="liename" style="width: 120px;">上架图书id</th>
            <th class="liename" style="width: 200px;">书主</th>
            <th class="liename" style="width: 300px;">上架时间</th>
        </tr>
        <c:forEach items="${requestScope.page.items}" var="up">
            <tr class="han">
                <td>${up.book_name}</td>
                <td>${up.book_id}</td>
                <td>${up.nickname}</td>
