				...
				<div id="content">
					<div class="login_form">
						<div class="login_box">
							...
							<div class="msg_cont">
								<b></b>
								<span class="errorMsg"><%=request.getAttribute("mes")==null?"请输入用户名和密码":request.getAttribute("mes")%></span>
							</div>
							<div class="form">
							...
							<div class="tit"  >
								<a style="margin-right: 198px;" href="pages/user/findpassword.jsp">忘记密码？</a>
